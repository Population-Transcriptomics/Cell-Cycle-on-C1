...
Images of *Fucci* cells loaded in the C1 capture array, were taken before cell lysis. Three modes have been used for imaging: bright field (BF), Green and Red. [Raw images](https://briefcase.riken.jp/public/mAF8gAzoLsdAVPwBXp1LS5HJzGlicAWQZwlMer8hKu5U) in the Cellomics specific C01 format were used for measuring fluorescence intensities and reporting errors in [Fiji ImageJ](http://fiji.sc/Fiji) All platforms version by using the macro [SetArea_Measure_UserConfirm.ijm](SetArea_Measure_UserConfirm.ijm). The usage of this macro is illustrated in the accompanying PDF file [Usage_of_ImageJ_macro_SetArea_Measure_UserConfirm.pdf](Usage_of_ImageJ_macro_SetArea_Measure_UserConfirm.pdf). The macro will ask the user to select the directory which contains all the raw image files. 
...
The Fiji ImageJ macro was run independently by Elo Madissoon, User 1 (file [Results_SetArea_Measure_UserConfirm_User1.txt](Results_SetArea_Measure_UserConfirm_User1.txt)) and Michael Böttcher, User 2 (file [Results_SetArea_Measure_UserConfirm_User2.txt](Results_SetArea_Measure_UserConfirm_User2.txt)). The current document explains the [column names](#names) in the results files, analyzes the [consistency](#consistency) of the measurements, compares and finds consensus in the [error reporting](#errorreport) and gives an [overview](#overview) of the final values.
...
```
##              cell_id     cell_coord_x    cell_coord_y        area          mean_ch2     
##  1772-062-248_A01:  1   Min.   :170.0   Min.   :151.0   Min.   :214.6   Min.   : 14.93  
##  1772-062-248_A02:  1   1st Qu.:217.2   1st Qu.:166.2   1st Qu.:214.6   1st Qu.: 23.32  
##  1772-062-248_A03:  1   Median :233.5   Median :176.0   Median :214.6   Median : 29.80  
##  1772-062-248_A04:  1   Mean   :247.4   Mean   :188.4   Mean   :221.2   Mean   : 43.12  
##  1772-062-248_A05:  1   3rd Qu.:259.0   3rd Qu.:206.0   3rd Qu.:228.0   3rd Qu.: 60.15  
##  1772-062-248_A06:  1   Max.   :363.0   Max.   :254.0   Max.   :228.0   Max.   :218.37  
##  (Other)         :372                                                                   
##     std_ch2           min_ch2         max_ch2       bg_coord_ch2_x  bg_coord_ch2_y   bg_area_ch2   
##  Min.   :  3.810   Min.   : 0.00   Min.   : 25.00   Min.   :120.0   Min.   :161.0   Min.   :214.6  
##  1st Qu.:  5.301   1st Qu.: 9.00   1st Qu.: 38.00   1st Qu.:168.0   1st Qu.:216.0   1st Qu.:214.6  
##  Median :  8.095   Median :12.00   Median : 52.00   Median :183.5   Median :225.5   Median :214.6  
##  Mean   : 19.783   Mean   :12.95   Mean   : 91.26   Mean   :197.4   Mean   :237.9   Mean   :221.2  
##  3rd Qu.: 27.661   3rd Qu.:16.00   3rd Qu.:128.50   3rd Qu.:209.0   3rd Qu.:255.8   3rd Qu.:228.0  
##  Max.   :128.649   Max.   :67.00   Max.   :488.00   Max.   :313.0   Max.   :304.0   Max.   :228.0  
##                                                                                                    
##   bg_mean_ch2      bg_std_ch2      bg_min_ch2      bg_max_ch2       area_ch3        mean_ch3     
##  Min.   :14.94   Min.   :3.609   Min.   : 0.00   Min.   :24.00   Min.   :214.6   Min.   : 10.39  
##  1st Qu.:16.93   1st Qu.:4.467   1st Qu.: 6.00   1st Qu.:30.00   1st Qu.:214.6   1st Qu.: 16.70  
##  Median :21.96   Median :4.670   Median : 9.00   Median :34.00   Median :214.6   Median : 39.83  
##  Mean   :20.86   Mean   :4.681   Mean   : 8.68   Mean   :33.16   Mean   :221.2   Mean   : 47.88  
##  3rd Qu.:22.87   3rd Qu.:4.889   3rd Qu.:11.00   3rd Qu.:36.00   3rd Qu.:228.0   3rd Qu.: 68.30  
##  Max.   :27.25   Max.   :5.501   Max.   :17.00   Max.   :42.00   Max.   :228.0   Max.   :238.86  
##                                                                                                  
##     std_ch3           min_ch3          max_ch3      bg_coord_ch3_x  bg_coord_ch3_y   bg_area_ch3   
##  Min.   :  3.827   Min.   :  0.00   Min.   : 19.0   Min.   :120.0   Min.   :157.0   Min.   :214.6  
##  1st Qu.:  4.872   1st Qu.:  4.00   1st Qu.: 30.0   1st Qu.:168.0   1st Qu.:216.0   1st Qu.:214.6  
##  Median : 17.341   Median :  6.00   Median : 90.5   Median :183.5   Median :225.5   Median :214.6  
##  Mean   : 27.816   Mean   :  9.68   Mean   :115.1   Mean   :197.4   Mean   :237.9   Mean   :221.2  
##  3rd Qu.: 43.501   3rd Qu.: 12.00   3rd Qu.:169.0   3rd Qu.:209.0   3rd Qu.:255.8   3rd Qu.:228.0  
##  Max.   :147.678   Max.   :116.00   Max.   :515.0   Max.   :313.0   Max.   :304.0   Max.   :228.0  
##                                                                                                    
##   bg_mean_ch3       bg_std_ch3      bg_min_ch3       bg_max_ch3                Error    
##  Min.   : 9.701   Min.   :3.710   Min.   : 0.000   Min.   :18.00   0-No Error     :277  
##  1st Qu.:12.560   1st Qu.:4.166   1st Qu.: 1.000   1st Qu.:23.00   1-No cell      : 52  
##  Median :13.212   Median :4.351   Median : 3.000   Median :25.00   2-Debris       :  7  
##  Mean   :13.797   Mean   :4.351   Mean   : 2.794   Mean   :25.31   3-OutOfFocus   : 22  
##  3rd Qu.:14.575   3rd Qu.:4.524   3rd Qu.: 4.000   3rd Qu.:27.00   4-MultipleCells: 20  
##  Max.   :22.664   Max.   :5.069   Max.   :10.000   Max.   :34.00                        
##                                                                                         
##                        Comment   
##  BG XY change              :  1  
##  BG change XY              :  1  
##  No comment                :373  
##  Small cell or debris?     :  2  
##  Very small cell or debris?:  1  
##                                  
## 
```
...
```
##  [1] "cell_id"        "cell_coord_x"   "cell_coord_y"   "area"           "mean_ch2"      
##  [6] "std_ch2"        "min_ch2"        "max_ch2"        "bg_coord_ch2_x" "bg_coord_ch2_y"
## [11] "bg_area_ch2"    "bg_mean_ch2"    "bg_std_ch2"     "bg_min_ch2"     "bg_max_ch2"    
## [16] "area_ch3"       "mean_ch3"       "std_ch3"        "min_ch3"        "max_ch3"       
## [21] "bg_coord_ch3_x" "bg_coord_ch3_y" "bg_area_ch3"    "bg_mean_ch3"    "bg_std_ch3"    
## [26] "bg_min_ch3"     "bg_max_ch3"     "Error"          "Comment"
```
...
```r
pairs(cbind(user1.mean = user1$mean_ch2, user2.mean = user2$mean_ch2, em.min = user1$min_ch2, user2.min = user2$min_ch2, user1.max = user1$max_ch2, user2.max = user2$max_ch2, user1.std = user1$std.ch2, user2.std = user2$std.ch2), lower.panel=panel.smooth, upper.panel=panel.cor, main="Comparison of values in Channel 2, green")
```

![plot of chunk unnamed-chunk-4](figure/unnamed-chunk-4-1.png) 

```r
pairs(cbind(user1.mean = user1$mean.ch3, user2.mean = user2$mean.ch3, user1.min = user1$min.ch3, user2.min = user2$min.ch3, user1.max = user1$max.ch3, user2.max = user2$max.ch3, user1.std = user1$std.ch3, user2.std = user2$std.ch3), lower.panel=panel.smooth, upper.panel=panel.cor, main="Comparison of values in Channel 3, red")
```

```
## Error in pairs.default(cbind(user1.mean = user1$mean.ch3, user2.mean = user2$mean.ch3, : only one column in the argument to 'pairs'
```
...
flBoxplot <- function (DATA){
  ...
  boxplot( x_ch2~y, main=title.2, las=1, horizontal=TRUE)
  boxplot( x_ch3~y, main=title.3, las=1, horizontal=TRUE)
}
...
```
## Error in eval(expr, envir, enclos): object 'x_ch2' not found
```
...
##                                                                                                    
##   bg_mean_ch3       bg_std_ch3      bg_min_ch3       bg_max_ch3                Error    
##  Min.   : 9.701   Min.   :3.710   Min.   : 0.000   Min.   :18.00   0-No Error     :293  
##  1st Qu.:12.560   1st Qu.:4.166   1st Qu.: 1.000   1st Qu.:23.00   1-No cell      : 50  
##  Median :13.212   Median :4.351   Median : 3.000   Median :25.00   2-Debris       :  8  
##  Mean   :13.797   Mean   :4.351   Mean   : 2.794   Mean   :25.31   3-OutOfFocus   : 17  
##  3rd Qu.:14.575   3rd Qu.:4.524   3rd Qu.: 4.000   3rd Qu.:27.00   4-MultipleCells: 10  
##  Max.   :22.664   Max.   :5.069   Max.   :10.000   Max.   :34.00                        
##                                                                                         
##                        Comment         Well               Run      discard       
##  BG XY change              :  1   C07    :  5   1772-062-248:62   Mode :logical  
##  BG change XY              :  1   C08    :  5   1772-062-249:62   FALSE:290      
##  No comment                :373   C11    :  5   1772-064-103:62   TRUE :88       
##  Small cell or debris?     :  2   C12    :  5   1772-067-038:96   NA's :0        
##  Very small cell or debris?:  1   D01    :  5   1772-067-039:96                  
##                                   D02    :  5                                    
##                                   (Other):348
```
