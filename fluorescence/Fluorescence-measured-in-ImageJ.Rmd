...
[Bio-Formats](https://www.openmicroscopy.org/site/support/bio-formats) plugin and can
open the files with commands such as `imagej -e 'run("Bio-Formats Macro Extensions"); Ext.openImagePlus("1772-062-248_A01_BF.C01")'`.
