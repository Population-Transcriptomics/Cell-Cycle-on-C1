...
The Fiji ImageJ macro was run independently by Elo Madissoon, User 1 (file [`r resultsUser1`](`r resultsUser1`)) and Michael Böttcher, User 2 (file [`r resultsUser2`](`r resultsUser2`)). The current document explains the [column names](#names) in the results files, analyzes the [consistency](#consistency) of the measurements, compares and finds consensus in the [error reporting](#errorreport) and gives an [overview](#overview) of the final values.
