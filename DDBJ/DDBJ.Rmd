...
The following script downloads metadata from DDBJ and creates a table that has 6 columns: "Library",  "Well", "DDBJ", "Index", "ExperimentAccession", "cell_id", and 472 rows. Each row represents a single cell. 
...
This script, and the page on [spike detection](../spikes/spikes.Rmd) assume
